...
gpt_plus_configs = {
    "tinymodel": TransformerModelArgs(
        dim=64, n_layers=2, n_heads=2, n_kv_heads=2,
        vocab_size=1024, max_seq_len=256,
        qk_norm_type="QKNormPlus",
        rope_theta=10000
    ),
    "debugmodel": TransformerModelArgs(
        dim=128, n_layers=6, n_heads=8, rope_theta=500000
    ),
    ...
    "8l512d": TransformerModelArgs(
        dim=512, n_layers=8, n_heads=4, rope_theta=500000
    ),
    ...
    "paper_8L512D": TransformerModelArgs(
        dim=512,
        n_layers=8,
        n_heads=8,
        n_kv_heads=8,
    ...
    "paper_12L512D": TransformerModelArgs(
        dim=512,
        n_layers=12,
        n_heads=8,
        n_kv_heads=8,
    ...
    "paper_8L768D": TransformerModelArgs(
        dim=768,
        n_layers=8,
        n_heads=12,
        n_kv_heads=12,
    ...
    "paper_12L768D": TransformerModelArgs(
        dim=768,
        n_layers=12,
        n_heads=12,
        n_kv_heads=12,
    ...
    "paper_6L256D": TransformerModelArgs(
        dim=256,
        n_layers=6,
        n_heads=4,
        n_kv_heads=4,
    ...
    "paper_6L384D": TransformerModelArgs(
        dim=384,
        n_layers=6,
        n_heads=6,
        n_kv_heads=6,
