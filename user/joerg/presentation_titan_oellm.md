...
| Flavor | dim | layers | heads | kv_heads | params |
|--------|-----|--------|-------|----------|--------|
| debugmodel | 256 | 4 | 8 | 4 | ~1M |
| 0.5B | 1024 | 24 | 16 | 8 | 0.5B |
| 0.6B | 1024 | 28 | 16 | 8 | 0.6B |
| 1.7B | 2048 | 28 | 16 | 8 | 1.7B |
| 4B | 2560 | 36 | 32 | 8 | 4B |
| 8B | 4096 | 36 | 32 | 8 | 8B |
| 14B | 5120 | 40 | 40 | 8 | 14B |
| 32B | 5120 | 64 | 40 | 8 | 32B |

Features: QK-norm, configurable RoPE theta, HF weight loading, MoE variants.
...
|---------|----------|-------------------|-----------|
| **JUWELS** | FZ Juelich | `jwlogin*`, `jwc*` | `titan_juwels_0.2.1.sif` |
| **Jupiter** | FZ Juelich | `jupiter*`, `jrc*` | `titan_jupiter_0.2.1.sif` |
| **Capella** | PSNC | `c1`-`c9` | `titan_capella_0.2.1.sif` |
